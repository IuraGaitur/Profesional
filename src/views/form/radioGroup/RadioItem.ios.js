        ...
        return (
            <View style={[style, {marginVertical: 10, marginRight: 10}]}>
                <Button key={this.props.title} rounded light titleStyle={{padding: 20}}
                        style={{width: '100%', height: '100%', backgroundColor: this.props.isSelected ? SELECTED : GRAY_LIGHT}}
                        onPress={this.props.onSelect}>
                    <Text style={{flex: 1, fontSize: 22, marginHorizontal: 18, textAlign: 'center', marginVertical: 14}}>{this.props.title}</Text>
                </Button>
            </View>);
    }
}